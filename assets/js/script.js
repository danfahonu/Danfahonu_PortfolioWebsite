...
const resources = {
    vi: {
        ...
        footer_tagline: "Business Analyst | Data Analyst Intern",
        footer_desc: "UFM graduate chuyên Business Analysis & ERP Implementation. Sẵn sàng đóng góp cho tổ chức với kỹ năng phân tích dữ liệu và tối ưu quy trình.",
        footer_cta: "Gửi tin nhắn",
        footer_links_title: "Liên Kết",
        footer_cv: "Tải CV",
        footer_location: "TP. Hồ Chí Minh, Việt Nam",
        footer_university: "Đại học Tài chính - Marketing",
        footer_connect: "Kết Nối",
        footer_availability: "✨ Sẵn sàng bắt đầu ngay",
        footer_copyright: "© 2026 Đặng Phạm Hồng Nhung.",
        footer_rights: "All rights reserved.",
        footer_made: "Được làm với",
        footer_location_short: "tại TP.HCM",
    ...
    en: {
        ...
        footer_tagline: "Business Analyst | Data Analyst Intern",
        footer_desc: "UFM graduate specializing in Business Analysis & ERP Implementation. Ready to contribute with data analysis and process optimization skills.",
        footer_cta: "Get in touch",
        footer_links_title: "Quick Links",
        footer_cv: "Download CV",
        footer_location: "Ho Chi Minh City, Vietnam",
        footer_university: "University of Finance - Marketing",
        footer_connect: "Connect",
        footer_availability: "✨ Available to start immediately",
        footer_copyright: "© 2026 Dang Pham Hong Nhung.",
        footer_rights: "All rights reserved.",
        footer_made: "Made with",
        footer_location_short: "in HCMC",
